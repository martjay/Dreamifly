...
export const ALL_VIDEO_MODELS: VideoModelConfig[] = [
  ...
  },
  {
    ...
    name: 'HappyHorse T2V',
    description: 'HappyHorse text-to-video model. Generates a 3-15 second video from a text prompt.',
  ...
  },
  {
    ...
    name: 'HappyHorse I2V',
    description: 'HappyHorse image-to-video model. Uses the uploaded image as the first frame and generates a 3-15 second video.',
  ...
  },
  {
    ...
    name: 'HappyHorse R2V',
    description: 'HappyHorse reference-to-video model. Uses 1-9 reference images and a prompt to generate a 3-15 second video.',
  ...
  },
  {
    ...
    description: 'HappyHorse video editing model. Edits a source video using a prompt and optional reference images.',
